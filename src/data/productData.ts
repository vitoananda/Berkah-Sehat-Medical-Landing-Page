...
export const products: Product[] = [
  {
    ...
    category: 'Bed Pasien',
    imageUrl: `${imgUrl}/Bed-Pasien-Crank-1.jpg`,
  },
  {
    id: 2,
    ...
    category: 'Bed Pasien',
    imageUrl: `${imgUrl}/Bed-Pasien-Crank-2.jpg`,
  },
  {
    id: 3,
    ...
    category: 'Bed Pasien',
    imageUrl: `${imgUrl}/Bed-Pasien-Crank-3.jpg`,
  },
  {
    id: 4,
    ...
    category: 'Bed Pasien',
    imageUrl: `${imgUrl}/Bed-Pasien-Elektrik-ABS.PNG`,
  },
  {
    id: 5,
    ...
    category: 'Kursi Roda',
    imageUrl: `${imgUrl}/Kursi-Roda-Elektrik.jpg`,
  },
  {
    id: 6,
    ...
    category: 'Kursi Roda',
    imageUrl: `${imgUrl}/Kursi-Roda-Reclining.jpg`,
  },
  {
    id: 7,
    ...
    category: 'Kursi Roda',
    imageUrl: `${imgUrl}/Kursi-Roda-Semi-Travel-LAJ-1.jpg`,
  },
  {
    id: 8,
    ...
    description:
      'Merupakan kursi roda yang dapat digunakan bagi pasien bertubuh tanggung/sedikit besar. Dengan kursi roda travel LAJ, pasien dapat berpergian dengan nyaman, kursi roda travel ini dibuat dengan lebih mudah dibawa-bawa sehingga kursi roda ini sangat cocok untuk traveling atau berpindah pindah tempat.',
    category: 'Kursi Roda',
    imageUrl: `${imgUrl}/Kursi-Roda-Semi-Travel-LAJ.jpg`,
  },
  {
    id: 9,
    ...
    category: 'Kursi Roda',
    imageUrl: `${imgUrl}/Kursi-Roda-Semi-Travel-LB-1.jpg`,
  },
  {
    id: 10,
    ...
    description:
      'Merupakan kursi roda dengan ban kecil yang dapat membantu pasien dalam berpindah tempat dan lebih praktis karena ukurannya yang lebih kecil namun kekurangannya kursi roda ini tidak bisa digunakan untuk pasien yang memiliki berat badan yang besar karena hanya memiliki roda yang kecil. ',
    category: 'Kursi Roda',
    imageUrl: `${imgUrl}/Kursi-Roda-Semi-Travel-LB.jpg`,
  },
  {
    id: 11,
    ...
    category: 'Kursi Roda',
    imageUrl: `${imgUrl}/Kursi-Roda-Standar.jpg`,
  },
  {
    id: 12,
    ...
    category: 'Kursi Roda',
    imageUrl: `${imgUrl}/Kursi-Roda-Travel.jpg`,
  },
  {
    id: 13,
    ...
    category: 'Bed Pasien',
    imageUrl: `${imgUrl}/Matras-Decubitus.jpg`,
  },
  {
    id: 14,
    ...
    imageUrl: `${imgUrl}/Meja-Makan-Pasien.jpg`,
  },
  {
    id: 15,
    title: 'Nebulizer',
  ...
  },
  {
    ...
    category: 'Suction',
    imageUrl: `${imgUrl}/Suction.jpg`,
  },
  {
    id: 17,
    title: 'Tabung Oksigen 1M Kubik',
    description:
      'Memiliki daya simpan oksigen lebih banyak. Penggunaan dapat lebih lama. Biaya sewa sudah termasuk : Tabung Oksigen, Troli, Isi awal (bonus) yang siap untuk langsung di pakai. Rekomendasi : tabung oksigen ini cocok digunakan untuk pasien yang memerlukan asupan oksigen nonstop selama 2 jam.',
    category: 'Tabung Oksigen',
    imageUrl: `${imgUrl}/Tabung-Oksigen-1M-Kubik.jpg`,
  },
  {
    id: 18,
    ...
    category: 'Tabung Oksigen',
    imageUrl: `${imgUrl}/Tabung-Oksigen-6M-Kubik.jpg`,
  },
  {
    id: 19,
    ...
    category: 'Tandu',
    imageUrl: `${imgUrl}/Tandu-Aluminium.jpg`,
  },
  {
    id: 20,
    title: 'Tandu Kanvas',
    ...
    category: 'Tandu',
    imageUrl: `${imgUrl}/Tandu-Kanvas.jpg`,
  },
  {
    id: 21,
    title: 'Toilet Chair',
    ...
    imageUrl: `${imgUrl}/Toilet-Chair.jpg`,
  },
  {
    id: 22,
    ...
    category: 'Tongkat',
    imageUrl: `${imgUrl}/Tongkat-Kaki-4.jpg`,
  },
  {
    id: 23,
    ...
    description: '-',
    category: 'Tongkat',
    imageUrl: `${imgUrl}/Tongkat-Kaki-3.jpg`,
  },
  {
    id: 24,
    title: 'Tongkat Kruk',
    ...
    category: 'Tongkat',
    imageUrl: `${imgUrl}/Tongkat-Kruk.jpeg`,
  },
  {
    id: 25,
    ...
    category: 'Walker',
    imageUrl: `${imgUrl}/Walker-Non-Roda.jpg`,
  },
  {
    id: 26,
    title: 'Walker Roda',
    ...
    category: 'Walker',
    imageUrl: `${imgUrl}/Walker-Roda.jpg`,
  },
];
